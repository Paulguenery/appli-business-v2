/*
  # Add Call Statistics Table and Functions
  ...
  1. New Tables
    - `call_statistics`
      ...
      - `average_duration` (interval, computed)
      - `updated_at` (timestamptz)

  2. Security
    - Enable RLS on `call_statistics` table
    - Add policy for users to view their own statistics

  3. Functions
    - Add function to update call statistics
