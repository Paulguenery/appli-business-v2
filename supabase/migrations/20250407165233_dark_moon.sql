/*
  ...
  1. New Tables
    ...
    - subscription_features: Defines features and limits for each plan
    - subscription_history: Logs subscription plan changes

  2. Features
    - Three subscription tiers: freemium, standard, premium
