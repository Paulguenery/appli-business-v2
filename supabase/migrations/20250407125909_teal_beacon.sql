...
BEGIN
  ...
  VALUES 
    (owner5_id, 'alice.dupont2@example.com'),
    (owner6_id, 'marc.lambert2@example.com'),
    (seeker7_id, 'sarah.bernard2@example.com'),
    (seeker8_id, 'hugo.martin2@example.com'),
    (seeker9_id, 'lea.dubois2@example.com');
  ...
  WHERE name IN ('Healthcare', 'AI/ML', 'Technology');
  ...
  SELECT 
    ...
    id
  FROM project_interests 
  WHERE name IN ('Mobile Apps', 'Technology', 'Sustainability');
