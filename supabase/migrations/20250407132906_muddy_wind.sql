/*
  ...
  1. Changes
    - Add favorites table if not exists
    - Add RLS policies
    - Add function to get favorites with details
...
-- Drop existing function if it exists and create new version
DROP FUNCTION IF EXISTS get_favorites(uuid, text);
